...
namespace TMPro
{
    ...
    /// </summary>
    [AddComponentMenu("UI/TextMeshPro - Input Field Mod", 11)]
    ...
    #endif
    public class TMP_InputFieldMod : Selectable,
        ...
        IScrollHandler
    {
        ...
        private void GenerateCaret(VertexHelper vbo, Vector2 roundingOffset)
        {
            ...
            //float baseScale = (m_TextComponent.fontSize / fontAsset.faceInfo.scale * fontAsset.faceInfo.scale);
            float width = m_CaretWidth * fontAsset.faceInfo.lineHeight /** baseScale*/ * 0.005f;
